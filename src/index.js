...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let keySprite = new Image();
  keySprite.src = "./src/assets/entities/key/sprite.png";
  keySprite.onload = () => {
    gameState.sprites.key = keySprite;
  };
  ...
  // Coin-pouch HUD sprite sheet: 5 horizontal frames matching `bucketForCoinCount`
  // in src/scripts/ui/hud/coin_pouch.js (0 = deflated empty bag, 4 = full with
  // overflow coins). Generated by scripts/generate_coin_pouch_sprite.js.
  let coinPouchSprite = new Image();
  coinPouchSprite.src = "./src/assets/ui/coin_pouch/sprite.png";
  coinPouchSprite.onload = () => {
    gameState.sprites.coinPouch = coinPouchSprite;
  };
  ...
  const equipmentSprites = Object.freeze({
    ...
    battleaxe:    "./src/assets/items/equipment/weapons/greataxes/battleaxe/sprite.png",
    morningstar:  "./src/assets/items/equipment/weapons/maces/morningstar/sprite.png",
    hammer:       "./src/assets/items/equipment/weapons/hammers/hammer/sprite.png",
    warhammer:    "./src/assets/items/equipment/weapons/greathammers/warhammer/sprite.png",
    spear:        "./src/assets/items/equipment/weapons/polearms/spear/sprite.png",
    staff:        "./src/assets/items/equipment/weapons/staves/staff/sprite.png",
    wand:         "./src/assets/items/equipment/weapons/wands/wand/sprite.png",
    buckler:          "./src/assets/items/equipment/shields/buckler/sprite.png",
    bucklerSide:      "./src/assets/items/equipment/shields/buckler/side.png",
    targe:            "./src/assets/items/equipment/shields/targe/sprite.png",
    targeSide:        "./src/assets/items/equipment/shields/targe/side.png",
    rotella:          "./src/assets/items/equipment/shields/rotella/sprite.png",
    rotellaSide:      "./src/assets/items/equipment/shields/rotella/side.png",
    vikingShield:     "./src/assets/items/equipment/shields/viking_shield/sprite.png",
    vikingShieldSide: "./src/assets/items/equipment/shields/viking_shield/side.png",
    roundShield:      "./src/assets/items/equipment/shields/round_shield/sprite.png",
    roundShieldSide:  "./src/assets/items/equipment/shields/round_shield/side.png",
    heaterShield:     "./src/assets/items/equipment/shields/heater_shield/sprite.png",
    heaterShieldSide: "./src/assets/items/equipment/shields/heater_shield/side.png",
    kiteShield:       "./src/assets/items/equipment/shields/kite_shield/sprite.png",
    kiteShieldSide:   "./src/assets/items/equipment/shields/kite_shield/side.png",
    towerShield:      "./src/assets/items/equipment/shields/tower_shield/sprite.png",
    towerShieldSide:  "./src/assets/items/equipment/shields/tower_shield/side.png",
  });
  for (const [key, src] of Object.entries(equipmentSprites)) {
    const img = new Image();
    img.src = src;
    img.onload = () => {
